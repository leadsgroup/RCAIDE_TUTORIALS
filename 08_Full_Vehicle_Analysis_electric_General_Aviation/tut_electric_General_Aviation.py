...
from RCAIDE.Methods.Weights.Physics_Based_Buildups.Electric                 import converge_weight , compute_weight
...
def vehicle_setup():
    ...
    rel_path                              = ospath.split( 'tut_electric_General_Aviation.py')[0]  +  '..' + separator   
