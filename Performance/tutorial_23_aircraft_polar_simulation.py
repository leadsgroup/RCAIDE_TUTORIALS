...
def main(): 
    ...
    Mach_number_range                 = np.atleast_2d(np.linspace(0.1, 0.9, 10))
    angle_of_attack_range             = np.atleast_2d(np.linspace(-5, 12, 18))
    control_surface_deflection_range  = np.atleast_2d(np.linspace(0,30,7))*Units.degrees 
