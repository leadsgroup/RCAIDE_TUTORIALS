...
def subsonic_aero_coefficient_test(vehicle,Mach_range,fig_title ):
    ...
    no_sur_aerodynamics.geometry                           = vehicle
    ...
    sur_aerodynamics.geometry                           = vehicle
...
def subsonic_control_surface_test(control_surface_deflection_angles): 
    ...
    for i in range (num_def):  
        state.conditions.aerodynamics.angles.alpha    = AoA_range 
        no_sur_aerodynamics.geometry.wings.main_wing.control_surfaces.flap.deflection = control_surface_deflection_angles[i]
        ...
        sur_aerodynamics.geometry.wings.main_wing.control_surfaces.flap.deflection = control_surface_deflection_angles[i]    
        _                 = sur_aerodynamics.evaluate(state)        
